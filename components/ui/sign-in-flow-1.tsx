                ...
                {initialCanvasVisible && (
                    <div className="absolute inset-0">
                        <CanvasRevealEffect
                            ...
                            colors={[
                                [0, 112, 243], // Aether Brand Customization
                                [0, 112, 243],
                            ]}
                            dotSize={6}
                            reverse={false}
                                ...
                                {step === "email" ? (
                                    ...
                                    >
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-[1.8rem] text-white/70 font-light">to Aether Network</p>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            <form action={loginUser}>
                                                <button
                                                    type="submit"
                                                    onClick={() => sessionStorage.setItem("userName", "Google User")}
                                    ...
                                    >
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-[1.25rem] text-white/50 font-light">Welcome to the future.</p>
                                        </div>
                                        ...
                                        <motion.div
                                            ...
                                            className="py-10"
                                        >
                                            <div className="mx-auto w-16 h-16 rounded-full bg-gradient-to-br from-[#0070f3] to-white/70 flex items-center justify-center">
                                        ...
                                        {/* TRIGGER FINAL NEXT SERVER ACTION TO SET SESSION REDIRECT */}
                                        <form action={loginUser}>
                                            <motion.button
                                                onClick={() => {
