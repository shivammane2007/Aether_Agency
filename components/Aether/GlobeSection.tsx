...
export default function GlobeSection() {
  return (
    <div className="flex bg-black items-center justify-center px-4 py-8 sm:px-6 md:px-8 border-t border-[#1a1a1a]">
      <div className="w-full max-w-7xl rounded-2xl border border-[#1a1a1a] bg-black/40 overflow-hidden relative">
        ...
        <div className="flex flex-col md:flex-row min-h-[500px]">
          {/* Left content */}
          <div className="flex-1 flex flex-col justify-center p-6 sm:p-8 md:p-14 relative z-10">
          ...
          {/* Right — Globe */}
          <div className="flex-1 flex items-center justify-center p-2 sm:p-4 md:p-0 min-h-[320px] sm:min-h-[400px]">
            <Globe className="max-w-full origin-center scale-[0.72] sm:scale-90 md:scale-100 transform-gpu" size={460} dotColor="rgba(0, 112, 243, ALPHA)" arcColor="rgba(0, 112, 243, 0.5)" markerColor="rgba(0, 200, 255, 1)" />
          </div>
        </div>
      </div>
    </div>
