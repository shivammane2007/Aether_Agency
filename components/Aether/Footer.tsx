    ...
    <footer className="md:rounded-t-[3rem] relative w-full max-w-7xl mx-auto flex flex-col items-center justify-center rounded-t-3xl border-t border-[#1a1a1a] bg-[radial-gradient(35%_128px_at_50%_0%,rgba(0,112,243,0.1),transparent)] px-6 py-12 lg:py-16 overflow-hidden">
      ...
      <div className="grid w-full gap-8 xl:grid-cols-3 xl:gap-8 relative z-10">
        <AnimatedContainer className="space-y-4">
          ...
          <p className="text-gray-400 mt-8 text-sm md:mt-0 max-w-xs leading-relaxed">
            The infrastructure layer for the next generation of visionary
            engineering teams.
            <br className="mb-4" />© {new Date().getFullYear()} Aether Agency. All
            rights reserved.
          </p>
        </AnimatedContainer>
          ...
          {footerLinks.map((section, index) => (
            <AnimatedContainer key={section.label} delay={0.1 + index * 0.1}>
              <div className="mb-10 md:mb-0">
                ...
                <ul className="text-gray-400 mt-4 space-y-3 text-sm">
