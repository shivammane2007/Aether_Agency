                    ...
                    <div className="flex flex-col gap-10 sm:gap-12">
                        <div className="grid grid-cols-2 gap-6 sm:gap-8">
                            <div className="flex flex-col">
                                <span className="text-4xl sm:text-5xl font-black text-white mb-2">2.5B+</span>
                            ...
                            <div className="flex flex-col">
                                <span className="text-4xl sm:text-5xl font-black text-white mb-2">15k+</span>
                                <span className="text-gray-400 text-sm uppercase tracking-widest font-semibold flex items-center gap-2">
                                    <div className="w-1 h-1 rounded-full bg-[#0070f3]" />
                                    Engineering Teams
                                </span>
                            ...
                            <div className="flex flex-col pt-4">
                                <span className="text-4xl sm:text-5xl font-black text-white mb-2">&lt; 50<span className="text-2xl sm:text-3xl text-gray-500">ms</span></span>
                                <span className="text-gray-400 text-sm uppercase tracking-widest font-semibold flex items-center gap-2">
                        ...
                        <div className="pt-8 border-t border-[#1a1a1a]">
                            ...
                            <div className="flex flex-wrap items-center gap-x-8 sm:gap-x-12 gap-y-6 sm:gap-y-8 opacity-70 grayscale">
                                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-widest">VERCEL</h3>
                                <h3 className="text-xl sm:text-2xl font-black text-white italic">Stripe</h3>
                                <h3 className="text-xl sm:text-2xl font-medium text-white tracking-tighter">Linear</h3>
                                <h3 className="text-xl sm:text-2xl font-black text-white uppercase tracking-tight">Ramp</h3>
                            </div>
                        </div>
                    </div>
