                    ...
                    <div className="flex flex-col gap-12">
                        <div className="grid grid-cols-2 gap-8">
                            <div className="flex flex-col">
                                ...
                                <span className="text-[#888888] text-sm uppercase tracking-widest font-semibold flex items-center gap-2">
                            ...
                            <div className="flex flex-col pt-4">
                                <span className="text-5xl font-black text-white mb-2">&lt; 50<span className="text-3xl text-[#555]">ms</span></span>
                                <span className="text-[#888888] text-sm uppercase tracking-widest font-semibold flex items-center gap-2">
                        ...
                        <div className="pt-8 border-t border-[#1a1a1a]">
                            <p className="text-[#555555] text-sm mb-6 uppercase tracking-wider font-medium">Trusted by engineering leaders at</p>
